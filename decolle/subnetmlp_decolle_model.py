...
class subnetmlpDECOLLE(DECOLLEBase):
    ...
    def __init__(self,
        ...
        l1_1, ro1_1 = self.decolle_linear(inF=16 * 16, outF=64, out_channels=11,
                                                    alpha=alpha[0],
                                                    beta=beta[0],
                                                    alpharp=alpharp[0],
                                                    deltat=deltat,
        ...
        l1_2, ro1_2 = self.decolle_linear(inF=16 * 16, outF=64, out_channels=11,
                                                    alpha=alpha[0],
                                                    beta=beta[0],
                                                    alpharp=alpharp[0],
                                                    deltat=deltat,
                                                    ...
                                                    lif_layer_type=LIFLayer,
                                                    do_detach=True if method == 'rtrl' else False)
        l1_3, ro1_3 = self.decolle_linear(inF=16 * 16, outF=64, out_channels=11,
                                                    alpha=alpha[0],
                                                    beta=beta[0],
                                                    alpharp=alpharp[0],
                                                    deltat=deltat,
                                                    ...
                                                    lif_layer_type=LIFLayer,
                                                    do_detach=True if method == 'rtrl' else False)
        l1_4, ro1_4 = self.decolle_linear(inF=16 * 16, outF=64, out_channels=11,
                                                    alpha=alpha[0],
                                                    beta=beta[0],
                                                    alpharp=alpharp[0],
                                                    deltat=deltat,
